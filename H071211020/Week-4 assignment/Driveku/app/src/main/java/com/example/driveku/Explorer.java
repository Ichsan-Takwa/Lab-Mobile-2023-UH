...
public class Explorer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new RecycleViewAdapter(this, postList, R.layout.activity_file_detail);
        adapterLagi = new RecycleViewAdapter(this, postList, R.layout.activity_file_preview);
        ...
        binding.addFileBtn.setOnClickListener(v -> {
